...
<link rel="stylesheet" type="text/css" href="./Thông tin cá nhân_files/responsive.css"><style type="text/css"></style><style type="text/css">.fb_hidden{position:absolute;top:-10000px;z-index:10001}.fb_reposition{overflow:hidden;position:relative}.fb_invisible{display:none}.fb_reset{background:none;border:0;border-spacing:0;color:#000;cursor:auto;direction:ltr;font-family:"lucida grande", tahoma, verdana, arial, sans-serif;font-size:11px;font-style:normal;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:1;margin:0;overflow:visible;padding:0;text-align:left;text-decoration:none;text-indent:0;text-shadow:none;text-transform:none;visibility:visible;white-space:normal;word-spacing:normal}.fb_reset>div{overflow:hidden}@keyframes fb_transform{from{opacity:0;transform:scale(.95)}to{opacity:1;transform:scale(1)}}.fb_animate{animation:fb_transform .3s forwards}
...
<body class="category-page">
    ...
    <div id="fb-root" class=" fb_reset"><div style="position: absolute; top: -10000px; width: 0px; height: 0px;"><div><iframe name="fb_xdm_frame_https" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" src="./Thông tin cá nhân_files/xd_arbiter.html" style="border: none;"></iframe></div><div></div></div></div>
    
    <script src="./Thông tin cá nhân_files/sdk.js.tải xuống" async="" crossorigin="anonymous"></script><script async="" src="./Thông tin cá nhân_files/analytics.js.tải xuống"></script><script id="facebook-jssdk" src="./Thông tin cá nhân_files/sdk.js(1).tải xuống"></script><script>
...
<script src="./Thông tin cá nhân_files/WebResource.axd" type="text/javascript"></script>


<script src="./Thông tin cá nhân_files/ScriptResource.axd" type="text/javascript"></script>
<script src="./Thông tin cá nhân_files/ScriptResource(1).axd" type="text/javascript"></script>
<div class="aspNetHidden">
                ...
                <div class="carousel-inner">
                    <div class="item" style="background: #86bd3b;">
                        ...
                        <a href="https://sharecode.vn/thanh-vien-upload.htm" title="UPLOAD source code KIẾM TIỀN cùng Sharecode.vn">
                            <img src="./Thông tin cá nhân_files/code-hay-upload-kiem-tien.jpg">
                        </a>
                ...
                <div class="container">                    
                    <div class="nav-top-links">
                        <a class="first-item" href="tel:+84981282756" title="Click gọi ngay!">
                            <img alt="hotline" src="./Thông tin cá nhân_files/phone.png">0981.282.756</a>
                        <a href="mailto:sharecode.contact@gmail.com" title="Click để gửi email!">
                            <img alt="email sharecode" src="./Thông tin cá nhân_files/email.png">Sharecode.contact@gmail.com</a>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-3 col-md-3 logo">
                        <a href="https://sharecode.vn/">
                            <img alt="Trang chủ sharecode.vn" title="Sharecode.vn" src="./Thông tin cá nhân_files/logo.png"></a>
                    </div>
...
<div style="height: 30px; width: 140px; float: left; margin-left: 10px;">
    <img src="./Thông tin cá nhân_files/captcha.jpg" alt="captcha" class="imgCaptcha" height="30" width="80">
                            ...
                            <div class="col-xs-12">
                                <ul class="tab-child nav nav-tabs" role="tablist">
                                    <li role="presentation" class="col-sm-3 active"><a href="https://sharecode.vn/thong-tin-ca-nhan.htm#boxMomo" role="tab" data-toggle="tab">
                                        <img src="./Thông tin cá nhân_files/vi-momo.png"></a></li>
        ...
        Mã khác
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 line-h">
                                                ...
                                                <a onclick="return Check_Paypal();" id="ucPopupMoney_btnPaypal" href="javascript:__doPostBack(&#39;ctl00$ctl00$ctl00$ucPopupMoney$btnPaypal&#39;,&#39;&#39;)"><img src="./Thông tin cá nhân_files/btn-paypal.png" alt="PayPal Checkout"></a>
                                                <img src="./Thông tin cá nhân_files/btn-paypal-2.png" alt="PayPal Checkout card" class="paypal-card">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div role="tabpanel" class="row tab-pane fade" id="mnSendATM">
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-vcb.png">
                                    </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-bidv.png">
                                    </div>
                                    <div style="float: left;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-vtb.png">
                                    </div>
                                    <div style="float: left;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-scb.png">
                                    </div>
                                    <div style="float: left;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-tech.png">
                                    </div>
                                    <div style="float: left;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-acb.png">
                                    </div>
                                    <div style="float: left;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-tpb.png">
                                    </div>
                                    <div style="float: left;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-mb.png">
                                    </div>
                                    <div style="float: left;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-agri.png">
                                    </div>
                                    <div style="float: left;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-vp.png">
                                    </div>
                                    <div style="float: left;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-shb.png">
                                    </div>
                                    <div style="float: left;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="clear">
                                    <div style="float: left; margin: 2px 10px 0 0;">
                                        <img src="./Thông tin cá nhân_files/bank-mar.png">
                                    </div>
                                    <div style="float: left;">
                         ...
                         <div role="tabpanel" class="row tab-pane fade" id="mnVisa">
                            ...
                            <br>
                            <img src="./Thông tin cá nhân_files/credit-card.png"></div>
        ...
        Mã khác
            ...
            <div class="modal-footer">
                <p class="text-center green bold line-h">
                    <img src="./Thông tin cá nhân_files/secure.png" height="40" alt="secure">
                                    ...
                                    <ul class="vertical-menu-list">
                                        <li>
                                            <a class="parent" href="https://sharecode.vn/thong-tin-ca-nhan.htm#">
                                                <img class="icon-menu" alt="Thể loại code" src="./Thông tin cá nhân_files/2.png">PHÂN LOẠI CODE</a>
                                            <div class="vertical-dropdown-menu" style="width: 900px;">
                                                ...
                                                <li class=""><a href="https://sharecode.vn/ngon-ngu-lap-trinh/android-15.htm">
                                                    <img class="icon-menu" alt="Android" src="./Thông tin cá nhân_files/3.png">Android</a></li>
                                            
                                                <li class=""><a href="https://sharecode.vn/ngon-ngu-lap-trinh/ios-23.htm">
                                                    <img class="icon-menu" alt="iOS" src="./Thông tin cá nhân_files/3.png">iOS</a></li>
                                            
                                                <li class=""><a href="https://sharecode.vn/ngon-ngu-lap-trinh/windows-phone-26.htm">
                                                    <img class="icon-menu" alt="Windows phone" src="./Thông tin cá nhân_files/3.png">Windows phone</a></li>
                                            
                                                <li class=""><a href="https://sharecode.vn/ngon-ngu-lap-trinh/php-mysql-21.htm">
                                                    <img class="icon-menu" alt="PHP &amp; MySQL" src="./Thông tin cá nhân_files/3.png">PHP &amp; MySQL</a></li>
                                            
                                                <li class=""><a href="https://sharecode.vn/ngon-ngu-lap-trinh/wordpress-29.htm">
                                                    <img class="icon-menu" alt="WordPress" src="./Thông tin cá nhân_files/3.png">WordPress</a></li>
                                            
                                                <li class=""><a href="https://sharecode.vn/ngon-ngu-lap-trinh/joomla-28.htm">
                                                    <img class="icon-menu" alt="Joomla" src="./Thông tin cá nhân_files/3.png">Joomla</a></li>
                                            
                                                <li class=""><a href="https://sharecode.vn/ngon-ngu-lap-trinh/visual-c-17.htm">
                                                    <img class="icon-menu" alt="Visual C#" src="./Thông tin cá nhân_files/3.png">Visual C#</a></li>
                                            
                                                <li class=""><a href="https://sharecode.vn/ngon-ngu-lap-trinh/aspaspnet-16.htm">
                                                    <img class="icon-menu" alt="Asp/Asp.Net" src="./Thông tin cá nhân_files/3.png">Asp/Asp.Net</a></li>
                                            
                                                <li class=""><a href="https://sharecode.vn/ngon-ngu-lap-trinh/javajsp-20.htm">
                                                    <img class="icon-menu" alt="Java/JSP" src="./Thông tin cá nhân_files/3.png">Java/JSP</a></li>
                                            
                                                <li class=""><a href="https://sharecode.vn/ngon-ngu-lap-trinh/visual-basic-19.htm">
                                                    <img class="icon-menu" alt="Visual Basic" src="./Thông tin cá nhân_files/3.png">Visual Basic</a></li>
                                            
                                                <li class="cat-link-orther"><a href="https://sharecode.vn/ngon-ngu-lap-trinh/cocos2d-24.htm">
                                                    <img class="icon-menu" alt="Cocos2D" src="./Thông tin cá nhân_files/3.png">Cocos2D</a></li>
                                            
                                                <li class="cat-link-orther"><a href="https://sharecode.vn/ngon-ngu-lap-trinh/unity-27.htm">
                                                    <img class="icon-menu" alt="Unity" src="./Thông tin cá nhân_files/3.png">Unity</a></li>
                                                ...
                                                <li class="cat-link-orther"><a href="https://sharecode.vn/ngon-ngu-lap-trinh/html-template-25.htm">
                                                    <img class="icon-menu" alt="Html &amp; Template" src="./Thông tin cá nhân_files/3.png">Html &amp; Template</a></li>
                                            
                                                <li class="cat-link-orther"><a href="https://sharecode.vn/ngon-ngu-lap-trinh/khac-22.htm">
                                                    <img class="icon-menu" alt="Khác" src="./Thông tin cá nhân_files/3.png">Khác</a></li>
    ...
    <div id="mainbody_contentbody_contentpage_panDefaultButton" onkeypress="javascript:return WebForm_FireDefaultButton(event, &#39;mainbody_contentbody_contentpage_btnUpdate&#39;)">
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="ctl00$ctl00$ctl00$mainbody$contentbody$contentpage$updateEmailMoney" type="text" id="mainbody_contentbody_contentpage_updateEmailMoney" placeholder="VD: ThanhTam92@gmail.com" maxlength="40" class="form-control">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input name="ctl00$ctl00$ctl00$mainbody$contentbody$contentpage$updatePhone" type="text" id="mainbody_contentbody_contentpage_updatePhone" maxlength="20" placeholder="VD: 01... or 09.. or +84..." class="form-control" value="0328864555">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <img src="./Thông tin cá nhân_files/avanta2.png" id="mainbody_contentbody_contentpage_Avanta" class="pro-img" width="90" height="90" alt="meo9xit - Hà Duy Hưng" title="Hà Duy Hưng">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-5 control-label">Chọn ảnh khác</label>
                <div class="col-sm-5  pro-top7">
                    <input type="file" name="ctl00$ctl00$ctl00$mainbody$contentbody$contentpage$fulImage" id="mainbody_contentbody_contentpage_fulImage" title="Bạn hãy chọn ảnh ở đây" onchange="javascript:ImageURL();">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-5 control-label bold">Nhận Email thông báo</label>
                <div class="col-sm-5  pro-top7">
                    <div>
                        <input name="ctl00$ctl00$ctl00$mainbody$contentbody$contentpage$CheckboxFree" type="checkbox" id="mainbody_contentbody_contentpage_CheckboxFree" value="download-free" checked="checked">
                        <span>Email download code miễn phí</span>
                    </div>
                    <div>
                        <input name="ctl00$ctl00$ctl00$mainbody$contentbody$contentpage$CheckboxCode" type="checkbox" id="mainbody_contentbody_contentpage_CheckboxCode" value="download-code" checked="checked">
                        <span>Email download code có phí</span>
                    </div>
                    <div>
                        <input name="ctl00$ctl00$ctl00$mainbody$contentbody$contentpage$CheckboxSend" type="checkbox" id="mainbody_contentbody_contentpage_CheckboxSend" value="send-code" checked="checked">
                        <span>Email nhận code giới thiệu từ bạn bè</span>
                    </div>
                    <div>
                        <input name="ctl00$ctl00$ctl00$mainbody$contentbody$contentpage$CheckboxSave" type="checkbox" id="mainbody_contentbody_contentpage_CheckboxSave" value="save-code" checked="checked">
                        <span>Email lưu code cho tôi</span>
                    </div>
                    <div>
                        <input name="ctl00$ctl00$ctl00$mainbody$contentbody$contentpage$CheckboxUploadWait" type="checkbox" id="mainbody_contentbody_contentpage_CheckboxUploadWait" value="upload-code" checked="checked">
                        <span>Email upload code chờ duyệt</span>
                    </div>
                    <div>
                        <input name="ctl00$ctl00$ctl00$mainbody$contentbody$contentpage$CheckboxUploadTested" type="checkbox" id="mainbody_contentbody_contentpage_CheckboxUploadTested" value="upload-code-tested" checked="checked">
                        <span>Email upload code BQT đã duyệt</span>
                    </div>
                    <div>
                        <input name="ctl00$ctl00$ctl00$mainbody$contentbody$contentpage$CheckboxMessage" type="checkbox" id="mainbody_contentbody_contentpage_CheckboxMessage" value="message" checked="checked">
                        <span>Email nhận thông báo, marketing...</span>
                    </div>
                    <div>
                        <input id="Checkbox8" type="checkbox" name="ReceviedEmail" disabled="disabled" checked="checked">
                        <span class="txt-colo">Email Rút tiền</span>
                    </div>
                    <div>
                        <input id="Checkbox9" type="checkbox" name="ReceviedEmail" disabled="disabled" checked="checked">
                        <span class="txt-colo">Email báo giao dịch bán code</span>
                    </div>
                    <div>
                        <input id="Checkbox10" type="checkbox" name="ReceviedEmail" disabled="disabled" checked="checked">
                        <span class="txt-colo">Email quên mật khẩu</span>
                    </div>
...
<div class="block left-module box-border2">
    <div class="pro-left">
        <a href="https://sharecode.vn/thong-tin-ca-nhan.htm">
            <img src="./Thông tin cá nhân_files/avanta2.png" id="mainbody_contentbody_ucProfile_Avanta" class="prof_img" alt="meo9xit - Hà Duy Hưng" width="90" height="90" title="meo9xit - Hà Duy Hưng">
        </a>
    </div>
    <div class="pro-right">
...
<script src="./Thông tin cá nhân_files/floater_xlib.js.tải xuống"></script>
<script type="text/javascript">
...
<div id="floating_banner_left" style="text-align: right; position: fixed; overflow: hidden; width: 120px; z-index: 99999; display: none; left: -70.5px; top: 300px;">
    <div id="floating_banner_left_content">
        <a href="https://sharecode.vn/kien-thuc-lap-trinh/dich-vu-thiet-ke-website-chuyen-nghiep-voi-gia-cuc-re-va-nhieu-uu-dai-tai-sharecodevn-880.htm" target="_blank">
            <img src="./Thông tin cá nhân_files/thiet-ke-web-gia-re.jpg" border="0" width="120" alt=""></a><br>
    </div>
</div>
<div id="floating_banner_right" style="text-align: left; position: fixed; overflow: hidden; width: 120px; z-index: 99999; left: 1299.5px; top: 300px; display: none;">
    <div id="Div2">
        <a href="https://topcode.vn/" target="_blank">
            <img src="./Thông tin cá nhân_files/Ra-mat-topcode.jpg" border="0" width="120" alt=""></a><br>
    </div>
</div>
  <script>
                    ...
                    <div class="container">
                        ...
                        <div id="introduce-box" class="row">
                            <div class="col-md-3">
                                <div id="address-box">
                                    <a href="https://sharecode.vn/">
                                        <img src="./Thông tin cá nhân_files/logo.png" alt="Sharecode.vn"></a>
                                    <div id="address-list">
                        ...
                        <div id="trademark-box" class="row">
                            <div class="col-sm-12">
                                <ul id="trademark-list">
                                    ...
                                    <li>
                                        <img src="./Thông tin cá nhân_files/b1.png" alt="ngan luong">
                                    </li>
                                    <li>
                                        <img src="./Thông tin cá nhân_files/b10.png" alt="bao kim">
                                    </li>
                                    <li>
                                        <img src="./Thông tin cá nhân_files/b11.png" alt="momo">
                                    </li>
                                    <li>
                                        <img src="./Thông tin cá nhân_files/b8.png" alt="paypal">
                                    </li>
                                    <li>
                                        <img src="./Thông tin cá nhân_files/b5.png" alt="vietcombank">
                                    </li>
                                    <li>
                                        <img src="./Thông tin cá nhân_files/b9.png" alt="vietin bank">
                                    </li>
                                    <li>
                                        <img src="./Thông tin cá nhân_files/b6.png" alt="agribank">
                                    </li>
                                    <li>
                                        <img src="./Thông tin cá nhân_files/b7.png" alt="bidv">
                                    </li>
                        ...
                        <div id="footer-menu-box">
                            <p class="text-center">
                                ...
                                <a href="https://www.dmca.com/Protection/Status.aspx?ID=e3cfb854-1733-4462-a9e8-0ef4661d6600&amp;refurl=https://sharecode.vn/thong-tin-ca-nhan.htm" title="DMCA.com Protection Status" class="dmca-badge">
                                    <img src="./Thông tin cá nhân_files/dmca-badge-w150-5x1-09.png" alt="DMCA.com Protection Status"></a>
                                <script src="./Thông tin cá nhân_files/DMCABadgeHelper.min.js.tải xuống"> </script>
                            </p>
                        </div>
                    </div>
                </footer>
    ...
    <!-- Script-->
    <script type="text/javascript" src="./Thông tin cá nhân_files/jquery-1.11.2.min.js.tải xuống"></script>
    <script type="text/javascript" src="./Thông tin cá nhân_files/bootstrap.min.js.tải xuống"></script>
    <script type="text/javascript" src="./Thông tin cá nhân_files/select2.min.js.tải xuống"></script>
    <script type="text/javascript" src="./Thông tin cá nhân_files/owl.carousel.min.js.tải xuống"></script>
    <script type="text/javascript" src="./Thông tin cá nhân_files/jquery.actual.min.js.tải xuống"></script>
    <script type="text/javascript" src="./Thông tin cá nhân_files/theme-script.js.tải xuống"></script>
    <script type="text/javascript" src="./Thông tin cá nhân_files/jquery-ui.min.js.tải xuống"></script>
    <script type="text/javascript">
    ...
    <script src="./Thông tin cá nhân_files/platform.js.tải xuống" async="" defer="" gapi_processed="true">
  {lang: 'vi'}
    </script>
...
{ "@context" : "http://schema.org",
  ...
  "contactPoint" : [{
    ...
    <link href="./Thông tin cá nhân_files/iosOverlay.css" rel="stylesheet">
    <script src="./Thông tin cá nhân_files/iosOverlay.js.tải xuống"></script>
