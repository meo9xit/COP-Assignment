                        ...
                        <div class="body">
                            <form id = "formSubmit">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="categoryName" class="form-control" name = "categoryName" placeholder="Enter category name!" value = "${model.categoryName}">
                                    </div>
                                </div>                           
                                <br>
    ...
    function addNew(data) {
        $.ajax({
            ...
            success: function (result) {
            	window.location.href = "/chiasetailieu/CateController";
            },
            error: function (error) {
            	window.location.href = "/chiasetailieu/CateController?type=add";
            }
        });
    }
