...
<c:url var ="NewURL" value="/sub_category-new"/>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <!-- Sweet Alert Css -->
    <link href="style/admin/plugins/sweetalert/sweetalert.css" rel="stylesheet" />
                        ...
                        <div class="body">
                            <form id = "formSubmit">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="username" class="form-control" name = "username" placeholder="Enter your email address" value = "${model.username}">
                                    </div>
                                </div>
                                <label for="password">Password</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="password" id="password" class="form-control" name = "password" placeholder="Enter your password" value = "${model.password }">
                                    </div>
                                </div>

                                <br>
                                <input type="button" class="btn btn-primary m-t-15 waves-effect" id = "btnAdd" value = "Add"/>
                            </form>
                        </div>
                    </div>
                </div>
