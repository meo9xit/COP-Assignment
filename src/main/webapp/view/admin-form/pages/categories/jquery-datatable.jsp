...
<head>
    ...
    <link href="style/admin/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css" rel="stylesheet">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="view/admin-form/index.html">ADMINBSB - MATERIAL DESIGN</a>
            </div>
...
<!-- End categories -->                    
    ...
    <script src="style/admin/plugins/jquery-datatable/skin/bootstrap/js/dataTables.bootstrap.js"></script>
    <script src="style/admin/plugins/jquery-datatable/extensions/export/dataTables.buttons.min.js"></script>
    <script src="style/admin/plugins/jquery-datatable/extensions/export/buttons.flash.min.js"></script>
    <script src="style/admin/plugins/jquery-datatable/extensions/export/jszip.min.js"></script>
    <script src="style/admin/plugins/jquery-datatable/extensions/export/pdfmake.min.js"></script>
    <script src="style/admin/plugins/jquery-datatable/extensions/export/vfs_fonts.js"></script>
    <script src="style/admin/plugins/jquery-datatable/extensions/export/buttons.html5.min.js"></script>
    <script src="style/admin/plugins/jquery-datatable/extensions/export/buttons.print.min.js"></script>
