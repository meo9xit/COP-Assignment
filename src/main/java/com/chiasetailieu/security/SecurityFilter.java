...
import com.chiasetailieu.security.UserRoleRequestWrapper;
import com.chiasetailieu.utils.AppUtils;
import com.chiasetailieu.utils.SecurityUtils;
...
public class SecurityFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
        ...
        if (loginedUser != null) {
            ...
            // Các vai trò (Role).
            String roles = loginedUser.getRole().toString();
        ...
        if (SecurityUtils.isSecurityPage(request)) {
            ...
            if (!hasPermission) {
                ...
                RequestDispatcher dispatcher //
                        = request.getServletContext().getRequestDispatcher("/view/AccessDenied.html");
